...
Module.prototype._compile = function(content, filename) {
  ...
  if (global.v8debug && filename === resolvedArgv) {
  ...
  if (process.inspectorPause && filename === resolvedArgv) {
    process.binding('node_debugger').waitForStartup(this._run.bind(this, filename, compiledWrapper));
  } else {
    return this._run(filename, compiledWrapper);
  }
};

Module.prototype._run = function(filename, compiledWrapper) {
